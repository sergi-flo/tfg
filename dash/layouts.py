    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                ...
                html.Div(html.Button(id="learn-more-button", children=["Learn More"])),
            ],
        ),
        # Body
        html.Div(
            ...
            children=[
                        ...
                        Card(
                            [
                                dcc.Dropdown(
                                    ...
                                    clearable=False,
                                    options=[
                                        {"label": k, "value": k} for k in patient_list
                                    ],
                ...
                html.Div(
                    ...
                    children=[dcc.Graph(id="graph-plot", style={"height": "98vh"})],
                ),
            ],
        ),
    ],
